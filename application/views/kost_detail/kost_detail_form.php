...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown no-arrow">
                    <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?= $first_name ?></span>
        ...
        <div class="container-fluid">
            <div class="row" style="margin-bottom: 10px">
                <div class="col-md-4">
                    <h2 style="margin-top:0px">Kost Detail <?php echo $button ?></h2>
                </div>
                <div class="card" style="width:100%; height:100%">
                    <div class="card-body">
                        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="int">Nama Kost</label>
                                <select class="form-control" name="id_kost" required>
                                    <option selected>Pilih Kost</option>
                                    <?php
                                    foreach ($nama_kost as $key => $value) {
                                    ?>
                                        <option value="<?php echo $value->id; ?>" <?php if ($value->id == $id_kost) {
                                                                                        echo 'selected';
                                                                                    } ?>><?php echo $value->nama_kost; ?></option>
                                    <?php
                                    }
                                    ?>
                                </select>
                            ...
                            <div class="form-group">
                                <label for="nama_kamar">Nama Kamar <?php echo form_error('nama_kamar') ?></label>
                                <input type="text" class="form-control" name="nama_kamar" id="nama_kamar" placeholder="Nama Kamar" value="<?php echo $nama_kamar; ?>" required />
                            </div>
                            <div class="form-group">
                                <label for="deskripsi_kamar">Deskripsi Kamar <?php echo form_error('deskripsi_kamar') ?></label>
                                <textarea class="form-control" rows="3" name="deskripsi_kamar" id="deskripsi_kamar" placeholder="Deskripsi Kamar" required><?php echo $deskripsi_kamar; ?></textarea>
                            </div>
                            <div class="form-group">
                            ...
                            <?php if (!empty($foto)) { ?>
                                <div class="container" style="margin-bottom: 3.5rem">
                                    <h3>Foto Kamar Saat Ini</h3>
                                    <?php
                                    $foto = explode(',', $foto);
                                    foreach ($foto as $foto) {
                                        echo '<img src="' . base_url('assets/img/' . $foto) . '" style="margin-top: 2rem;margin-bottom: 2rem; width:75%; height:75%">';
                                    }
                                    ?>
                                </div>
                            ...
                            <div class="form-group" id="form-foto">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <input type="file" class="form-control dropify" name="foto_kamar[]" id="foto_kamar" />
                                    </div>
                                    <div class="col-md-3">
                                        <input type="file" class="form-control dropify" name="foto_kamar[]" id="foto_kamar" />
                                    </div>
                            ...
                            <a href="<?php echo site_url('kost_detail') ?>" class="btn btn-default">Cancel</a>
                        </form>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        //         $("#foto-kamar1").after(img);
        //     }
        // });
        // $("#foto-kamar2").change(function(e) {
        //     for (var i = 0; i < e.originalEvent.srcElement.files.length; i++) {
        //         var file = e.originalEvent.srcElement.files[i];
        //         var img = document.createElement("img");
        //         img.id = "img-dipilih";
        ...
        //         }
        //         reader.readAsDataURL(file);
        //         $("#foto-kamar2").after(img);
        //     }
        // });
        // $("#foto-kamar3").change(function(e) {
        //     for (var i = 0; i < e.originalEvent.srcElement.files.length; i++) {
        //         var file = e.originalEvent.srcElement.files[i];
        //         var img = document.createElement("img");
        //         img.id = "img-dipilih";
